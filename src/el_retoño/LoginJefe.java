...
public class LoginJefe extends javax.swing.JFrame {
    ...
    public LoginJefe(MainMenu mainMenu) {
    ...
    private void initComponent() {
        ...
        jLabel1.setText("INICIAR SESIÓN - JEFE");
        ...
        jLabel4.setText("Usuario: jefe | Contraseña: 123");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if ("jefe".equals(usuario) && "123".equals(password)) {
            this.setVisible(false);
            JefePanel jefePanel = new JefePanel(this);
            jefePanel.setVisible(true);
        } else {
