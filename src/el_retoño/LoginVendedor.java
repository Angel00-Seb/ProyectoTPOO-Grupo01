...
public class LoginVendedor extends javax.swing.JFrame {
    ...
    public LoginVendedor(MainMenu mainMenu) {
    ...
    private void initComponent() {
        ...
        jLabel1.setText("INICIAR SESIÓN - VENDEDOR");
        ...
        jLabel4.setText("Usuario: vendedor | Contraseña: 123");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if ("vendedor".equals(usuario) && "123".equals(password)) {
            this.setVisible(false);
            VendedorPanel vendedorPanel = new VendedorPanel(this);
